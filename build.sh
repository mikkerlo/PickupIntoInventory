#!/usr/bin/env bash
# Rebuild pickupintoinventory-1.2.0.jar. Set GTNH and LIBS for your machine.
set -euo pipefail
...
jar cfm "$WORK/pickupintoinventory-1.2.0.jar" manifest.txt -C "$WORK/classes" .
echo "built $WORK/pickupintoinventory-1.2.0.jar"
